...
public class AesCryptUtil {
    ...
    public static String encrypt(String plainData, String password) {
        return encrypt(plainData, password, false, DEFAULT_MAX_CONFOUND_SIZE);
    }
    ...
    public static void main(String[] args) {
        //123是密码。z是加密秘文
//        System.out.println(encrypt("ecndev_live","cipherData"));
//        System.out.println(decrypt(encrypt("ecndev_live","cipherData"),"cipherData"));
//        System.out.println(encrypt("devlive@live","cipherData"));
//        System.out.println(decrypt(encrypt("devlive@live","cipherData"),"cipherData"));
        System.out.println(decrypt("IsJyEGEkY0XFTRQ21oWL5FYL","cipherData"));
    }
